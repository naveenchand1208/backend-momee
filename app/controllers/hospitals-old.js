const Hospital = require('../models/hospitals-old')
...
const HospitalDepartment = require('../models/hospitalDepartment-old');
...
exports.add = async (req, res, next) => {
    try {
        ...
        //const { name, address,translations, mobile, latitude, longitude, email } = req.body;
        ...
        if (!name || !address || !mobile || !req.file || !email) {
            return res.apiResponse(false, 'Hospital params is missing', {}, 400);
        }
